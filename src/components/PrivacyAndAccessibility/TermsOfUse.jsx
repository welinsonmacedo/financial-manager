...
Seja bem-vindo ao GerenteFinanceiro!
Estes termos e condições descrevem as regras de uso do site da empresa GerenteFinanceiro, localizado no endereço www.gerentefinanceiro.com.br.

Ao acessar este site, consideramos que você está de acordo com os termos e condições abaixo. Não continue a usar o GerenteFinanceiro caso você discorde dos termos e condições descritos neste contrato.

Cookies:
O site usa cookies para ajudar na personalização da sua experiência na internet. Ao acessar o site GerenteFinanceiro, você concorda com o uso dos cookies requeridos.
...
Licença:
Exceto em casos em que for indicado o contrário, GerenteFinanceiro e seus licenciados têm direito à propriedade intelectual de todo o material postado no GerenteFinanceiro. Todos os direitos à propriedade intelectual são reservados.

Você não tem permissão para:

Copiar ou republicar materiais do GerenteFinanceiro
Vender, alugar ou sublocar materiais do GerenteFinanceiro
Reproduzir, duplicar ou copiar materiais do GerenteFinanceiro
Redistribuir conteúdos do GerenteFinanceiro
Este Acordo terá efeito a partir da data presente.

Partes deste site oferecem ao usuário a oportunidade de postar e discutir opiniões e informações em determinadas áreas. GerenteFinanceiro não filtra, edita, publica ou revisa Comentários antes que eles sejam apresentados no site. Comentários refletem as opiniões da pessoa que os posta. Na extensão em que as leis aplicáveis permitem, GerenteFinanceiro não se responsabiliza legalmente pelos Comentários ou quaisquer danos, riscos ou despesas causadas ou sofridas como resultado do uso, e/ou postagem e/ou aparência dos Comentários deste site.

GerenteFinanceiro reserva para si o direito de remover quaisquer Comentários que possam ser considerados inapropriados, ofensivos ou quebrem os Termos e Condições deste contrato.
...
Você por meio deste concede a GerenteFinanceiro a licença não-exclusiva de usar, reproduzir, editar e autorizar outros a usar, reproduzir ou editar qualquer um de seus Comentários em qualquer e todas as formas, formatos e mídias.
...
Se você representa uma das organizações listadas no parágrafo 2 acima e está interessado em postar um link para nosso site, você deve nos informar de seu interesse enviando um e-mail para GerenteFinanceiro. Por favor, inclua seu some, o nome da sua organização e suas informações de contato, assim como a URL do seu site, uma lista das URLs do nosso site que você pretende usar como links, e uma lista dos sites nos quais você pretende publicar nossas URLs. Aguarde entre 2 e 3 semanas para receber uma resposta.
...
Não será permitido o uso ou a publicação de links para o logo e/ou outros elementos visuais da GerenteFinanceiro sem um acordo de licença para o uso da marca registrada.
